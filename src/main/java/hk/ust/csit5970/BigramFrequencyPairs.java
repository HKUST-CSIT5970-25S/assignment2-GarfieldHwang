...
/**
 * Compute the bigram frequency using "pairs" approach
 */
public class BigramFrequencyPairs extends Configured implements Tool {
    ...
    /*
     * Mapper: emits <PairOfStrings(w1,w2), 1> and <PairOfStrings(w1, *), 1>
     */
    private static class MyMapper extends
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            if (words.length > 1){
                ...
                WORD.set(previous_word, "*"); // Emit word count
                ...
                for (int i = 1; i < words.length; i++) {
                    ...
                    BIGRAM.set(previous_word, w); // Emit bigram count
    ...
    /*
     * Reducer: calculate relative frequencies
     */
    private static class MyReducer extends
            Reducer<PairOfStrings, IntWritable, Text, FloatWritable> {
        ...
        public void reduce(PairOfStrings key, Iterable<IntWritable> values,
            ...
            if (key.getRightElement().equals("*")) { // Output total count for word
                totalCount = sum;
                currentWord = key.getLeftElement();
                VALUE.set(totalCount);
                Text outputKey = new Text(currentWord);
                context.write(outputKey, VALUE);

            } else { // Output relative frequency for bigram
    ...
    public int run(String[] args) throws Exception {
        ...
        /*
         * A MapReduce program consists of four components: a mapper, a
